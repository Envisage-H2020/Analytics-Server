...
def CleanData(fileName):
    ...
    dc = DataCleaner()
    count_user_cleaned = dc.clean_user(fileName, score, date, users, names, classes, output_files)
    
    # replace new file to old file via renaming
    os.remove(fileName)
    os.rename('cleaned_data.json',fileName)
...
class DataCleaner(object):
    ...
    def clean_user(self, file_name, score, date, users, names, classes, output_files):
...
if __name__ == '__main__':
    ...
    dc = DataCleaner()
    count_user_cleaned = dc.clean_user(file_name, score, date, users, names, classes, output_files)
    # write cleaned users to new jsonp file

    print ('Date Interval')
    print (date)
    print ('Count Rows Cleaned')
    print (len(count_user_cleaned))
    # print (names)
